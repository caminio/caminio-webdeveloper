 ...
 * @Last Modified time: 2014-05-25 23:02:26
 *
...
PeRuProcessor.prototype.startSearch = function( content, options, done ){
  ...
  var methods = {
    runJS: options.methods.runJS.run,
    compileJade: options.methods.layoutCompiler.compile,
    contentCompiler: options.methods.contentCompiler
  };
